...
import {
  isEmpty_default
} from "./chunk-F2MXYUQQ.js";
import {
  JSON_SCHEMA,
  load
} from "./chunk-3Y2CSPZE.js";
import {
  registerLayoutLoaders
} from "./chunk-JXZLJZB4.js";
import "./chunk-7R7JQIIE.js";
import "./chunk-RHFET4LI.js";
import "./chunk-NO7AJWF3.js";
import "./chunk-DW3YL4PF.js";
import "./chunk-UW656XRU.js";
import "./chunk-NI7BASFX.js";
import {
  dedent,
  registerIconPacks
} from "./chunk-2PJHRBS4.js";
import {
  cleanAndMerge,
  decodeEntities,
  encodeEntities,
  ...
  removeDirectives,
  utils_default
} from "./chunk-X5FBSBV7.js";
import "./chunk-UVOFV4PD.js";
import {
  UnknownDiagramError,
  addDirective,
...
var loader = __name(async () => {
  const { diagram: diagram2 } = await import("./c4Diagram-AHTNJAMY-UMRSADDU.js");
...
var loader2 = __name(async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-DWJPFMVM-GIUYMHXW.js");
...
var loader4 = __name(async () => {
  const { diagram: diagram2 } = await import("./erDiagram-SMLLAGMA-YOFJEZK7.js");
...
var loader5 = __name(async () => {
  const { diagram: diagram2 } = await import("./gitGraphDiagram-UUTBAWPF-SDODCU7A.js");
...
var loader6 = __name(async () => {
  const { diagram: diagram2 } = await import("./ganttDiagram-T4ZO3ILL-OQX7HHWC.js");
...
var loader7 = __name(async () => {
  const { diagram: diagram2 } = await import("./infoDiagram-42DDH7IO-O6ZJZOHX.js");
...
var loader8 = __name(async () => {
  const { diagram: diagram2 } = await import("./pieDiagram-DEJITSTG-NFXYJLPC.js");
...
var loader9 = __name(async () => {
  const { diagram: diagram2 } = await import("./quadrantDiagram-34T5L4WZ-GOQQKT7X.js");
...
var loader10 = __name(async () => {
  const { diagram: diagram2 } = await import("./xychartDiagram-5P7HB3ND-HVZEE7F6.js");
...
var loader11 = __name(async () => {
  const { diagram: diagram2 } = await import("./requirementDiagram-MS252O5E-4RCAS6HG.js");
...
var loader12 = __name(async () => {
  const { diagram: diagram2 } = await import("./sequenceDiagram-FGHM5R23-PKDWCMVM.js");
...
var loader13 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-6PBFFD2Q-QYMQ52SJ.js");
...
var loader14 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-v2-HSJHXN6E-ISOTPFRJ.js");
...
var loader15 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-FHFEXIEX-KRYP2SR3.js");
...
var loader16 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-v2-QKLJ7IA2-OSSX4M7L.js");
...
var loader17 = __name(async () => {
  const { diagram: diagram2 } = await import("./journeyDiagram-VCZTEJTY-KV4MBMJV.js");
...
var loader19 = __name(async () => {
  const { diagram: diagram2 } = await import("./timeline-definition-GMOUNBTQ-BM2CDLXD.js");
...
var loader20 = __name(async () => {
  const { diagram: diagram2 } = await import("./mindmap-definition-QFDTVHPH-PKR7SPIF.js");
...
var loader21 = __name(async () => {
  const { diagram: diagram2 } = await import("./kanban-definition-6JOO6SKY-WIRND6F6.js");
...
var loader22 = __name(async () => {
  const { diagram: diagram2 } = await import("./sankeyDiagram-XADWPNL6-HEVCWDE5.js");
...
var loader23 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-TYMM5635-RSXABAHN.js");
...
var loader24 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-MMDJMWI5-NR6AVQXH.js");
...
var loader25 = __name(async () => {
  const { diagram: diagram2 } = await import("./blockDiagram-DXYQGD6D-EYRPHRZW.js");
...
var loader26 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-5BDNPKRD-Y57KRFVM.js");
...
var loader27 = __name(async () => {
  const { diagram: diagram2 } = await import("./architectureDiagram-Q4EWVU46-LJM3YV2Y.js");
...
var loader28 = __name(async () => {
  const { diagram: diagram2 } = await import("./ishikawaDiagram-UXIWVN3A-ESCXJ2TA.js");
...
var loader29 = __name(async () => {
  const { diagram: diagram2 } = await import("./vennDiagram-DHZGUBPP-XUJRAR34.js");
...
var loader30 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-G4DWMVQ6-EE4GFUVG.js");
...
var loader31 = __name(async () => {
  const { diagram: diagram2 } = await import("./wardleyDiagram-NUSXRM2D-W2WPF4TR.js");
